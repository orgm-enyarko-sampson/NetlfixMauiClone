...
namespace Netflix_Clone.Services
{
    ...
    {
        private const string APIKey = "fb0242d509c91a4f15ca992fb4b534f9";
        ...
        public async Task<IEnumerable<Media>> GetActionMoviesAsync() => await GetMediasAsync(TmdbUrls.Action);
